...
ALTER TABLE marketing_artifacts ADD COLUMN IF NOT EXISTS root_id text;
ALTER TABLE marketing_artifacts ADD COLUMN IF NOT EXISTS parent_id text REFERENCES marketing_artifacts(id) ON DELETE SET NULL;
...
ALTER TABLE posts ADD COLUMN IF NOT EXISTS artifact_id text REFERENCES marketing_artifacts(id) ON DELETE SET NULL;
