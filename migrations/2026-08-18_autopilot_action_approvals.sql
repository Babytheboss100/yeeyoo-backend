...
CREATE TABLE IF NOT EXISTS autopilot_action_approvals (
  ...
  plan_id TEXT REFERENCES tony_execution_plans(id), artifact_id TEXT NOT NULL REFERENCES marketing_artifacts(id), artifact_version INTEGER NOT NULL CHECK (artifact_version > 0),
  ...
  fingerprint CHAR(64) NOT NULL, nonce UUID NOT NULL, approved_by_user_id TEXT NOT NULL REFERENCES users(id),
