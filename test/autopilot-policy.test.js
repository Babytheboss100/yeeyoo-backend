...
const policy = { level:3, projectId:'p1', campaignId:'c1', maxBudget:100, currency:'NOK', channels:['meta'] }
const context = { userId:'u1', projectId:'p1', campaignId:'c1', artifactId:'a1', artifactVersion:2, budget:100, currency:'NOK', channels:['meta'], providerConnected:true, approvalNonce:'n1' }
const approval = { status:'approved', nonce:'n1', expiresAt:'2026-01-02T00:00:00Z', fingerprint:approvalFingerprint(context) }
