...
const approval = { status:'approved', action:'publish', projectId:'p1', campaignId:'c1', approvedByUserId:'owner1', approvedAt:'2025-12-31T00:00:00Z', nonce:'n1', expiresAt:'2026-01-02T00:00:00Z', fingerprint:approvalFingerprint({...context,action:'publish',policyVersion:policy.version}) }
