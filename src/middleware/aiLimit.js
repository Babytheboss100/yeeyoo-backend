...
const LIMITS = {
  free:       { tony_chat: { limit: 5,   window: '24h' }, brand_dna: { limit: 1,  window: '24h' }, smart_planner: { limit: 0,  window: '24h' }, seo: { limit: 0,  window: '30d' } },
  tier1:      { tony_chat: { limit: 50,  window: '24h' }, brand_dna: { limit: 5,  window: '24h' }, smart_planner: { limit: 2,  window: '24h' }, seo: { limit: 5,  window: '30d' } },
  tier2:      { tony_chat: { limit: 200, window: '24h' }, brand_dna: { limit: 20, window: '24h' }, smart_planner: { limit: 10, window: '24h' }, seo: { limit: 20, window: '30d' } },
  enterprise: { tony_chat: { limit: -1,  window: '24h' }, brand_dna: { limit: -1, window: '24h' }, smart_planner: { limit: -1, window: '24h' }, seo: { limit: -1, window: '30d' } },
}
