...
export const ACTIVITY_TYPES = Object.freeze(['tony_plan_completed','artifact_awaiting_approval','job_failed','campaign_ready','provider_disconnected','content_published','performance_data_available'])
