...
export const ACTIVITY_TYPES = Object.freeze(['tony_plan_completed','artifact_awaiting_approval','job_failed','campaign_ready','provider_disconnected','content_published','performance_data_available','meta_connection_initiated','meta_connection_completed','meta_capability_verified','meta_reauth_required','sosy_delegation_created','sosy_draft_completed','sosy_voice_turn'])
